...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Update Data Tagihan</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <form role="form" action='<?= base_url('tagihan/update') ?>' method='POST'>
          <div class="card-header">
            <div class= "row  float-sm-right">
              <button type='submit' name='insert' class="btn btn-primary" onclick="update_data()">Simpan</button>
            </div>
          </div>
          ...
          <div class="card-body">
            <div class="form-group row">
              ...
              <div class="col-sm-1">
                <input type="text" class="form-control" id="blok" name="blok" placeholder="blok" value="<?= substr($kode,11,3); ; ?>">
              </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-4">
                <input type="text" class="form-control" id="nama_nop" name="nama_nop" placeholder="Nama Pemilik" value="<?= $data_tagihan[0]; ?>">
              </div>
              <label for="nop" class="col-sm-2 col-form-label">Alamat</label>
              <div class="col-sm-4">
                <input type="text" class="form-control" id="alamat_nop" name="alamat_nop" placeholder="Nama Kampung" value="<?= $data_tagihan[1];?>">
              </div>
            </div>
            <div class="form-group row">
              <label for="nop" class="col-sm-2 col-form-label">RT</label>
              <div class="col-sm-1">
                <input type="text" class="form-control" id="rt_nop" name="rt_nop" placeholder="RT" Value="<?php if(!empty($data_tagihan[4])){echo $data_tagihan[4];} ?>">
              </div>
              <label for="nop" class="col-sm-2 col-form-label">RW</label>
              <div class="col-sm-1">
                <input type="text" class="form-control" id="rw_nop" name="rw_nop" placeholder="RW" Value="<?php if(!empty($data_tagihan[5])){echo $data_tagihan[5];}; ?>">
              </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-3">
                <input type="text" class="form-control" id="nama_wp" name="nama_wp" placeholder="Nama Wajib Pajak" value="<?php if(!empty($tagihan['nama_wp'])){ echo $this->kriptografi->deskripsi($tagihan['nama_wp'],$kunci);}?>">
              </div>
              <div class="col-sm-1">
              ...
              <div class="col-sm-1">
                <input type="number" class="form-control" id="luas_bumi" name="luas_bumi" placeholder="Luas Bumi" Value="<?= $data_tagihan[2]; ?>">
              </div>
              <label for="nop" class="col-sm-2 col-form-label">Luas Bangunan</label>
              <div class="col-sm-1">
                <input type="number" class="form-control" id="luas_bangunan" name="luas_bangunan" placeholder="Luas Bangunan" Value="<?= $data_tagihan[3]; ?>">
              </div>
            </div>
            <div class="form-group row">
              <label for="nop" class="col-sm-2 col-form-label">Besar Tagihan</label>
              <div class="col-sm-3">
                <input type="number" class="form-control" id="harga" name="harga" placeholder="Besar Tagihan" value="<?= $data_tagihan[7];?>">
              </div>
            </div>
          </div>
        </form>  
